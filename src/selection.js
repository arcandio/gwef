...
function GetLineOfElement(element) {
	var parent = element.closest('.mdline')
	if (element.classList.contains('mdline')){
		return element
	}
	else if (parent != null && parent.classList.contains('mdline')){
		return parent
	}
	else {
		console.log('NO MDLINE FOUND')
		return null
	}
}
